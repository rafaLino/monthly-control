  ...
  return (
    <Dropzone onDrop={handleDrop} accept={{ 'text/*': ['.csv'] }} maxFiles={1}>
      {({ getRootProps, getInputProps }) => (
        <section className="flex w-4/5 mt-12 min-h-96 items-center p-2 text-center justify-center border-2 border-dashed rounded-lg border-gray-500 text-gray-800 bg-slate-100/50 ">
          <div {...getRootProps()}>
            <input {...getInputProps()} />
            <span>
              <Trans
